 ...
 *         name.
 * 
 * <p>Java class for DD_Class_Reference complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DD_Class_Reference">
 *   <complexContent>
...
@XmlType(name = "DD_Class_Reference", propOrder = {
    "namespaceId",
    "name"
})
public class DDClassReference {
