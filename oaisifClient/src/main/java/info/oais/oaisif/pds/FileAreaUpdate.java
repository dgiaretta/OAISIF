...
@XmlType(name = "File_Area_Update", propOrder = {
    "file",
    "header",
    "tableCharacter",
    "tableDelimited"
})
public class FileAreaUpdate
    extends FileArea
{
