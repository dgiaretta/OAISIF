...
/**
 * The File Area Ancillary class describes a file
 *         and one or more tagged_data_objects contained within the
 *         file.
 * 
 * <p>Java class for File_Area_Ancillary complex type</p>.
 * 
...
@XmlType(name = "File_Area_Ancillary", propOrder = {
    "file",
    "arrayOrArray2DOrArray2DImage"
})
public class FileAreaAncillary
    extends FileArea
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "Checksum_Manifest", type = ChecksumManifest.class),
    ...
    protected List<ByteStream> arrayOrArray2DOrArray2DImage;
    ...
    /**
     * Gets the value of the arrayOrArray2DOrArray2DImage property.
     * 
     * <p>This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the arrayOrArray2DOrArray2DImage property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     * <pre>
     * getArrayOrArray2DOrArray2DImage().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the arrayOrArray2DOrArray2DImage property.
     */
    public List<ByteStream> getArrayOrArray2DOrArray2DImage() {
        if (arrayOrArray2DOrArray2DImage == null) {
            arrayOrArray2DOrArray2DImage = new ArrayList<>();
        }
        return this.arrayOrArray2DOrArray2DImage;
    }
