 ...
 * 
 * 
 * <p>Java class for Units_of_Pixel_Resolution_Linear</p>.
 * 
...
public enum UnitsOfPixelResolutionLinear {
    ...
    UnitsOfPixelResolutionLinear(String v) {
        value = v;
    }
     ...
     */
    public static UnitsOfPixelResolutionLinear fromValue(String v) {
        for (UnitsOfPixelResolutionLinear c: UnitsOfPixelResolutionLinear.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
