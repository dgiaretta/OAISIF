package info.oais.oaisif.oaisifDemo;
...
public class OaisIfDemo {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {					
					OaisIfDemo window = new OaisIfDemo();
	...
	private int displayTableAndSelectRow(Vector<Vector<String>> dataList, Vector<String> columnNames) {
         ...
         */
	    JOptionPane.showMessageDialog(null, new JScrollPane(table), "Select a row and click OK", JOptionPane.QUESTION_MESSAGE, null);
